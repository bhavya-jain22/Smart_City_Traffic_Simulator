...
public class Vehicle {
    ...
    public Vehicle(Intersection start, Intersection target, RoutingStrategy routingBrain) {
    ...
    public void moveNextTick() {
        ...
        if (roadProgress == 0.0) {
            ...
            if (roadIsHorizontal != currentLocation.isHorizontalGreen) {
        ...
        // Check if currently on a crowded road
        if (nextRoad.getTrafficDensity() > 0.5) {
            isWaitingOrSlow = true;
        } else {
